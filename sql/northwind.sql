...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 22 May 2021, 15:34:16
...
--
-- Tablo için tablo yapısı `inventory_transaction_types`
--
...
--
-- Tablo döküm verisi `inventory_transaction_types`
--
...
--
-- Tablo için tablo yapısı `orders_status`
--
...
--
-- Tablo için tablo yapısı `orders_tax_status`
--
...
--
-- Tablo döküm verisi `orders_tax_status`
--
...
--
-- Tablo için tablo yapısı `order_details_status`
--
...
--
-- Tablo döküm verisi `order_details_status`
--
...
--
-- Tablo için tablo yapısı `purchase_order_details`
--
...
--
-- Tablo döküm verisi `purchase_order_details`
--
...
--
-- Tablo için tablo yapısı `purchase_order_status`
--
...
--
-- Tablo döküm verisi `purchase_order_status`
--
...
--
-- Tablo için tablo yapısı `sales_reports`
--
...
--
-- Tablo döküm verisi `sales_reports`
--
...
--
-- Tablo için tablo yapısı `strings`
--
...
--
-- Tablo için indeksler `inventory_transactions`
--
...
--
-- Tablo için indeksler `inventory_transaction_types`
--
...
--
-- Tablo için indeksler `orders_status`
--
ALTER TABLE `orders_status`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `orders_tax_status`
--
...
--
-- Tablo için indeksler `order_details_status`
--
...
--
-- Tablo için indeksler `purchase_order_details`
--
...
--
-- Tablo için indeksler `purchase_order_status`
--
ALTER TABLE `purchase_order_status`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `sales_reports`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
...
--
-- Tablo için AUTO_INCREMENT değeri `purchase_order_details`
--
ALTER TABLE `purchase_order_details`
...
--
-- Tablo için AUTO_INCREMENT değeri `strings`
--
ALTER TABLE `strings`
...
--
-- Tablo kısıtlamaları `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
...
--
-- Tablo kısıtlamaları `purchase_order_details`
--
ALTER TABLE `purchase_order_details`
